...
import { makeValidateTransactionHistoryReturnSellerUseCase } from "@/useCases/@factories/wsRent/makeValidateTransactionHistoryReturnSellerUseCase";
import { IGetHistoricTrade } from "@/useCases/ws/interface/getHistoricTrade";
import { FastifyRequest, FastifyReply } from "fastify";

export async function validateHistoryTransactionRentReturnSellerController(
  req: FastifyRequest<{
  ...
  try {
    const makeValidade = makeValidateTransactionHistoryReturnSellerUseCase();
